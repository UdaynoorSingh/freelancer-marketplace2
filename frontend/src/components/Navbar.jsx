...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <div
        style={mobileMenuOpen ? sidebarOverlayOpen : sidebarOverlay}
          ...
          {user ? (
            <>
              ...
              {user.role === "freelancer" && (
                <div
                  style={sidebarItem}
                  onClick={() => handleSidebarItemClick("/create-gig")}
                >
                  <MdAdd size={20} />
                  Create Gig
                </div>
              ...
              {user.role === "freelancer" && (
                <div
                  style={sidebarItem}
                  onClick={() =>
                    handleSidebarItemClick("/freelancer-dashboard")
                  }
                >
                  Freelancer Dashboard
                </div>
              ...
              {user.role === "client" && (
                <div
                  style={sidebarItem}
                  onClick={() => handleSidebarItemClick("/client-dashboard")}
                >
                  Client Dashboard
                </div>
              )}
              ...
              {user.email === process.env.REACT_APP_ADMIN_EMAIL && (
                <div
                  style={sidebarItem}
                  onClick={() => handleSidebarItemClick("/admin")}
                >
                  Admin Panel
                </div>
              )}
            ...
            <>
              ...
              <div
                style={sidebarItem}
                onClick={() => handleSidebarItemClick("/register")}
              >
                Register
              </div>
            </>
