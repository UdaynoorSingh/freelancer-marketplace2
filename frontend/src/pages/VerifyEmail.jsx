...
const VerifyEmail = () => {
    ...
    return (
        <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f7f7f7' }}>
            <div style={{ background: '#fff', padding: '2rem', borderRadius: '12px', boxShadow: '0 4px 24px rgba(0,0,0,0.08)' }}>
                <h2 style={{ fontSize: '1.5rem', color: '#1dbf73', marginBottom: '1rem' }}>Email Verification</h2>
                <p>{message}</p>
            </div>
        </div>
    );
