    ...
    <div style={containerStyle}>
      ...
      <div style={headerStyle}>
        ...
        <p style={{ color: textSecondary }}>
          {favorites.length === 0
            ...
            : `You have ${favorites.length} favorite gig${
      ...
      {favorites.length === 0 ? (
        <div style={emptyStateStyle}>
          ...
          />
          <h3 style={{ color: textSecondary, marginBottom: "1rem" }}>
            No favorites yet
          </h3>
          <p style={{ color: textSecondary, marginBottom: "2rem" }}>
            Start exploring gigs and add them to your favorites by clicking the
            heart icon!
          </p>
          <button
            style={{
