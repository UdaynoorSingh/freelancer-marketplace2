...
const SearchResults = () => {
  ...
  useEffect(() => {
    ...
    fetch(
      `${process.env.REACT_APP_SERVER_URL}/api/services/search?${params.join(
        "&"
      )}`
    )
      .then((res) => res.json())
  ...
  return (
    <div style={{ padding: "2rem" }}>
      ...
      <h2 style={{ color: "#1dbf73", fontWeight: 700 }}>
        ...
        {search && (
          <>
            for <span style={{ color: "#404145" }}>{search}</span>
          </>
        )}
        {category && (
          <>
            <span style={{ color: "#404145" }}> in </span>
            <span style={{ color: "#1dbf73" }}>{category}</span>
          </>
        )}
      </h2>
      {loading && <p>Loading...</p>}
          ...
          return (
            <div key={service._id} style={cardStyle} className="gig-card">
              ...
              <img
                src={
                  images.length > 0
                    ? `${process.env.REACT_APP_SERVER_URL}/uploads/${images[0]}`
                ...
                <div>
                  <div style={sellerRow}>
                    ...
                    <span style={{ color: "#222", fontWeight: 600 }}>
                      {service.seller?.username || "Unknown"}
                    </span>
                  </div>
                  <div
                    style={{
                  ...
                  >
                    <span style={{ marginLeft: "auto", ...fromStyle }}>
                      From
                    </span>
